	...
	*/
	...
	public function getMonedas($moneda = null){
        ...
        $data = array(
            ...
            "peso argentino"          => (object) array("nombre"=>"Peso Argentino","iso"=>"ARS","isocode"=>"032","simboloDerecha"=>"","simboloIzquierda"=>"$ ","decimales"=>"2","separadordecimal"=>",","separadormiles"=>".","plural"=>"pesos"),
            "dolar australiano"       => (object) array("nombre"=>"Dólar Australiano","iso"=>"AUD","isocode"=>"036","simboloDerecha"=>"","simboloIzquierda"=>"$","decimales"=>"2","separadordecimal"=>".","separadormiles"=>",","plural"=>"dolares"),
            ...
            "dolar americano"         => (object) array("nombre"=>"Dólar Americano","iso"=>"USD","isocode"=>"840","simboloDerecha"=>"","simboloIzquierda"=>"us$","decimales"=>"2","separadordecimal"=>".","separadormiles"=>",","plural"=>"dolares"),
            "real brasileño"          => (object) array("nombre"=>"Real Brasileño","iso"=>"BRL","isocode"=>"986","simboloDerecha"=>"","simboloIzquierda"=>"R$","decimales"=>"2","separadordecimal"=>",","separadormiles"=>".","plural"=>"reales"),
            "rupia india"             => (object) array("nombre"=>"Rupia","iso"=>"INR","isocode"=>"356","simboloDerecha"=>"","simboloIzquierda"=>"Rs","decimales"=>"2","separadordecimal"=>",","separadormiles"=>".","plural"=>"rupias"),
            "dolar canadiense"        => (object) array("nombre"=>"Dólar Canadiense","iso"=>"CAD","isocode"=>"124","simboloDerecha"=>"","simboloIzquierda"=>"$","decimales"=>"2","separadordecimal"=>",","separadormiles"=>".","plural"=>"dolares"),
            "peso chileno"            => (object) array("nombre"=>"Peso Chileno","iso"=>"CLP","isocode"=>"152","simboloDerecha"=>"","simboloIzquierda"=>"$","decimales"=>"2","separadordecimal"=>",","separadormiles"=>".","plural"=>"pesos"),
            ...
            "peso colombiano"         => (object) array("nombre"=>"Peso Colombiano","iso"=>"COP","isocode"=>"170","simboloDerecha"=>"","simboloIzquierda"=>"$ ","decimales"=>"2","separadordecimal"=>"","separadormiles"=>"","plural"=>"pesos"),
            "peso mexicano"         => (object) array("nombre"=>"Peso Mexicano","iso"=>"MXN","isocode"=>"4217","simboloDerecha"=>"","simboloIzquierda"=>"$ ","decimales"=>"2","separadordecimal"=>"","separadormiles"=>"","plural"=>"pesos"),
            "peso cubano"             => (object) array("nombre"=>"Peso Cubano","iso"=>"CUP","isocode"=>"192","simboloDerecha"=>"","simboloIzquierda"=>"$","decimales"=>"2","separadordecimal"=>",","separadormiles"=>".","plural"=>"pesos"),
            "libra esterlina"         => (object) array("nombre"=>"Libra Esterlina","iso"=>"GBP","isocode"=>"826","simboloDerecha"=>"","simboloIzquierda"=>"£","decimales"=>"2","separadordecimal"=>".","separadormiles"=>",","plural"=>"libras"),

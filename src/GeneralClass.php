	...
	*/
	...
	public function getMonedas($moneda = null){
        ...
        $data = (object) array(
            ...
            "boliviano"               => (object) array("iso"=>"BOB","isocode"=>"068","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"bolivianos"),
            "dólar americano"         => (object) array("iso"=>"USD","isocode"=>"840","simboloDerecha"=>"","simboloIzquierda"=>"us$","decimales"=>"2","separadordecimal"=>".","separadormiles"=>",","plural"=>"dolares"),
            "real brasileño"          => (object) array("iso"=>"BRL","isocode"=>"986","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"reales"),
            "rupia india"             => (object) array("iso"=>"INR","isocode"=>"356","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"rupias"),
            "dólar canadiense"        => (object) array("iso"=>"CAD","isocode"=>"124","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"dolares"),
            "peso chileno"            => (object) array("iso"=>"CLP","isocode"=>"152","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"pesos"),
            "yuan"                    => (object) array("iso"=>"CNY","isocode"=>"156","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"yuanes"),
            "peso colombiano"         => (object) array("iso"=>"COP","isocode"=>"170","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"pesos"),
            "peso convertible (CUBA)" => (object) array("iso"=>"CUC","isocode"=>"931","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"pesos"),
            "peso cubano"             => (object) array("iso"=>"CUP","isocode"=>"192","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"pesos"),
            "libra esterlina"         => (object) array("iso"=>"GBP","isocode"=>"826","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"libras"),
            "yen"                     => (object) array("iso"=>"JPY","isocode"=>"392","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"yenes"),
            "sol"                     => (object) array("iso"=>"PEN","isocode"=>"604","simboloDerecha"=>"","simboloIzquierda"=>"","decimales"=>"","separadordecimal"=>"","separadormiles"=>"","plural"=>"soles"),
            "bolívar"                 => (object) array("iso"=>"VEF","isocode"=>"937","simboloDerecha"=>"Bs.","simboloIzquierda"=>"","decimales"=>"2","separadordecimal"=>",","separadormiles"=>".","plural"=>"bolivares"),
        );
